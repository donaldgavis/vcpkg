function(boost_modular_build)
    ...
    if(NOT VCPKG_CMAKE_SYSTEM_NAME OR VCPKG_CMAKE_SYSTEM_NAME STREQUAL "WindowsStore")
        ...
        set(ICUIN_LIB icuin)
        set(ICUDT_LIB icudt)
        set(ICU_LIB_RELEASE_SUFFIX .lib)
        set(ICU_LIB_DEBUG_SUFFIX d.lib)
    else()
        set(ICU_LIB_RELEASE_SUFFIX .a)
        set(ICU_LIB_DEBUG_SUFFIX .a)
        set(ICUUC_LIB libicuuc)
        set(ICUIN_LIB libicui18n)
        set(ICUDT_LIB libicudata)
